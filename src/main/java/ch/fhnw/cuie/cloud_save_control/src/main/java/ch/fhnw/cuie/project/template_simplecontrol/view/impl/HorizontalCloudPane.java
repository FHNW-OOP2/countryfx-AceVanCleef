 ...
 */
public class HorizontalCloudPane extends CloudPane implements Mixin{
    ...
    /* #Resizing */
    public static final double PREFERRED_HEIGHT = 100;
    public static final double MINIMUM_HEIGHT   = 25;
    public static final double MAXIMUM_HEIGHT   = 200;

    public static final double PREFERRED_WIDTH = 400;
    public static final double MINIMUM_WIDTH   = 100;
    public static final double MAXIMUM_WIDTH   = 800;
    ...
    public void initializeSelf() {
        ...
        //start position
        setOffsetFromOrigin(getWidth() * 0.25);
        //start size of source, target and skybackground
        setBaseRadii(getPrefWidth() * 0.125);            //todo: for horizontal, use getPrefWidth()
    ...
    public void initializeParts(){
        ...
        adjustFontSizeTo(getPrefHeight() / 2);
        ...
        source.setTranslateX(0 + getOffsetFromOrigin());

        target.setTranslateY(0);
        target.setTranslateX(0 - getOffsetFromOrigin());
        ...
        skybackground.setTranslateY(0);
        skybackground.setTranslateX(0 - getOffsetFromOrigin() - 2.5);
    ...
    public void addEventHandlers(){
        ...
        source.setOnMouseReleased(event -> {
            if (!hasSourceReachedSky()){
                ...
                setSourceCloudPos(0 - getOffsetFromOrigin(), 0);
    ...
    public void setupBindings() {
        ...
        offsetFromOriginProperty().bind(this.widthProperty().multiply(0.25));
    ...
    private void resetCloudAnimation(){
        ...
        animation.setToY(0);
        animation.setToX(getOffsetFromOrigin());
    ...
    private void resetDimensions(){
        //start size of source, target and skybackground
        setBaseRadii(getPrefWidth() * 0.125);
        setSkyRadius(getBaseRadii() * 1.5);
    }
